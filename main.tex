...
% If the experiment is a variation (a, b), let me know here. Otherwise leave this empty.
\def\exvar{b}

% What is the name of the experiment?
\def\exname{Bestimmung von Geschwindigkeitskonstanten}

% Subtitle of the experiment when it is a variation.
\def\exsubtitle{Die Auflösungsgeschwindigkeit eines Salzes}
...
\begin{titlepage}
    ...
    \vspace*{\baselineskip}
    \large{\experiment} \\
    \ifx\exsubtitle\empty\else\exsubtitle\fi
    \end{center}
    \vspace*{\fill}
    Durchgeführt am \exdate \\
